...
_recipes_pil_prescript(['WebPImagePlugin', 'PngImagePlugin', 'FitsStubImagePlugin', 'MpegImagePlugin', 'SgiImagePlugin', 'PixarImagePlugin', 'ImImagePlugin', 'EpsImagePlugin', 'MspImagePlugin', 'TiffImagePlugin', 'FtexImagePlugin', 'XpmImagePlugin', 'Hdf5StubImagePlugin', 'Jpeg2KImagePlugin', 'ImtImagePlugin', 'DcxImagePlugin', 'MpoImagePlugin', 'FliImagePlugin', 'BlpImagePlugin', 'XbmImagePlugin', 'McIdasImagePlugin', 'XVThumbImagePlugin', 'BufrStubImagePlugin', 'JpegImagePlugin', 'PpmImagePlugin', 'BmpImagePlugin', 'IcnsImagePlugin', 'SpiderImagePlugin', 'IptcImagePlugin', 'PdfImagePlugin', 'PsdImagePlugin', 'PalmImagePlugin', 'SunImagePlugin', 'PcxImagePlugin', 'CurImagePlugin', 'MicImagePlugin', 'FpxImagePlugin', 'PcdImagePlugin', 'GbrImagePlugin', 'GribStubImagePlugin', 'TgaImagePlugin', 'DdsImagePlugin', 'WmfImagePlugin', 'GifImagePlugin', 'IcoImagePlugin'])
...
DEFAULT_SCRIPT='CircuitCreator.py'
SCRIPT_MAP={}
_run()
